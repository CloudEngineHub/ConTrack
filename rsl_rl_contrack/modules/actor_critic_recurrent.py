...
from rsl_rl_contrack.networks import MLP, EmpiricalNormalization, HiddenState, Memory
...
class ActorCriticRecurrent(nn.Module):
    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        self.critic = MLP(rnn_hidden_dim, 2, critic_hidden_dims, activation)
    ...
    def act_inference(self, obs: TensorDict) -> torch.Tensor:
        ...
        if self.state_dependent_std:
            return torch.tanh(self.actor(out_mem)[..., 0, :])
        else:
            return torch.tanh(self.actor(out_mem))
